...
<div class="mycontent">
    ...
    <p><b>Инструкция.</b> Вам предлагается ряд утверждений. Выберите одно утверждение в
        ...
        <table border="1" cellpadding="8" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q1" type="radio" value="2">Я все время несчастен и не могу освободиться от этого
                        чувства.</p>
                    <p><input name="q1" type="radio" value="3">Я настолько несчастен и опечален, что не могу этого
                        вынести.</p>
                </td>
            </tr>
            ...
            <tr>
                <td>2</td>
                <td>
                    <p><input name="q2" type="radio" value="0">Думая о будущем, я не чувствую себя особенно
                        разочарованным.</p>
                    ...
                    <p><input name="q2" type="radio" value="3">Я чувствую, что будущее безнадежно и ничего не изменится
                        к лучшему.</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q3" type="radio" value="1">Я чувствую, что у меня было больше неудач, чем у
                        большинства других людей.</p>
                    <p><input name="q3" type="radio" value="2">Когда я оглядываюсь на прожитую жизнь, все, что я вижу,
                        это череды неудач. </p>
            ...
            <tr>
                <td>4</td>
                <td>
                    <p><input name="q4" type="radio" value="0">Я получаю столько же удовольствия от жизни, как и раньше.
                    </p>
                    <p><input name="q4" type="radio" value="1">Я не получаю столько же удовольствия от жизни, как и
                        раньше.</p>
                    <p><input name="q4" type="radio" value="2">Я не получаю настоящего удовлетворения от чего бы то ни
                        было.</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q9" type="radio" value="1">У меня есть мысли о том, чтобы покончить с собой, но я
                        этого не делаю.</p>
                    <p><input name="q9" type="radio" value="2">Я хотел бы покончить жизнь самоубийством.</p>
                    <p><input name="q9" type="radio" value="3">Я бы покончил с собой, если бы представился удобный
                        случай.</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q10" type="radio" value="3">Раньше я еще мог плакать, но теперь не смогу, даже если
                        захочу.</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q11" type="radio" value="3">Меня уже ничто не раздражает, потому что все стало
                        безразлично.</p>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q13" type="radio" value="2">Я испытываю больше трудностей в принятии решений, чем
                        прежде.</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q14" type="radio" value="1">Я обеспокоен, что выгляжу постаревшим и
                        непривлекательным.</p>
                    <p><input name="q14" type="radio" value="2">Я чувствую, что изменения, происходящие в моей
                        внешности, сделали меня непривлекательным.</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q15" type="radio" value="1">Мне надо приложить дополнительные усилия, чтобы начать
                        что-либо делать.</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q16" type="radio" value="2">Я просыпаюсь на 1-2 часа раньше, чем обычно и с трудом
                        могу заснуть снова.</p>
                    <p><input name="q16" type="radio" value="3">Я просыпаюсь на несколько часов раньше обычного и не
                        могу снова заснуть.</p>
                </td>
            </tr>
            ...
            <tr>
                <td>19</td>
                <td>
                    <p><input name="q19" type="radio" value="0">Если в последнее время я и потерял в весе, то очень
                        немного.</p>
            ...
            <tr>
                ...
                <td>
                    ...
                    <p><input name="q20" type="radio" value="1">Меня беспокоят такие проблемы, как различные боли,
                        расстройства желудка, запоры.</p>
                    <p><input name="q20" type="radio" value="2">Я настолько обеспокоен своим здоровьем, что мне даже
                        трудно думать о чем-нибудь другом.</p>
                    <p><input name="q20" type="radio" value="3">Я до такой степени обеспокоен своим здоровьем, что
                        вообще ни о чем не могу думать.</p>
                </td>
            </tr>
            ...
            <tr>
                <td>21</td>
                <td>
                    <p><input name="q21" type="radio" value="0">Я не замечал каких-либо изменений в моих сексуальных
                        интересах.</p>
